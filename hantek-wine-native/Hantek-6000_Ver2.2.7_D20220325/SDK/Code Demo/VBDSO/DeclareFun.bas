...
Public Declare Function dsoHTSetSampleRate Lib "HTHardDll.dll" (ByVal nDeviceIndex As Integer, ByVal nYTFormat As Integer, pRelayControl As Any, pSTControl As Any) As Integer
