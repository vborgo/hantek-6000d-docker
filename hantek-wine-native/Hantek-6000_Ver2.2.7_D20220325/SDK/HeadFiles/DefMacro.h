...
//#define OS_100
#ifdef Scope
	#define NOLOGO
	#define	DEVICE_NAME					_T("Scope")
	#define PROGRAM_TITLE				_T("Scope")

#elif defined Protek
	#define NOLOGO
	#define	DEVICE_NAME					_T("Protek-6254BD")
	#define PROGRAM_TITLE				_T("Protek-6254BD Ver2.2.2")
#elif defined MO2000
	#define NOLOGO
	#define	DEVICE_NAME					_T("MO2000")
	#define PROGRAM_TITLE				_T("MO2000 Ver2.1.35")
#elif defined OS_100
	#define NOLOGO
	#define	DEVICE_NAME					_T("OS-100")
	#define PROGRAM_TITLE				_T("OS-100 Ver2.2.2")
#elif defined Hantek
	#define	DEVICE_NAME					_T("Hantek-6000")
	#define PROGRAM_TITLE				_T("Hantek-6000 Ver2.2.2")
#elif defined DSOE
	#define NOLOGO
	#define	DEVICE_NAME					_T("DSO-6000")
	#define PROGRAM_TITLE				_T("DSO-6000 Ver2.2.2")
#elif defined GermanDSO
	#define SPLASH_SCREEN
	#define NOLOGO
	#define	DEVICE_NAME					_T("DSO-3000")
	#define PROGRAM_TITLE				_T("DSO-3074 Ver2.2.2")
#elif defined ORCA
	#define SPLASH_SCREEN
	#define NOLOGO
	#define	DEVICE_NAME					_T("OHUS5250")
	#define PROGRAM_TITLE				_T("OHUS5250")
#endif
	#define SF_VERSION					_T("2.0.9");
	#define VERTICAL_8BIT
	#define MAX_TIMEDIV_NUM				36	//总时基档位个数		
	...
	#define TRI_SEN_50MV	2
	#define TRI_SEN_100MV	2
	#define TRI_SEN_200MV	5
	#define TRI_SEN_500MV	2
	#define TRI_SEN_1V		2
	#define TRI_SEN_2V		5
	#define TRI_SEN_5V		2
	#define TRI_SEN_10V		2
...
//幅度校正
#define ZEROCALI_FIX_OFFSET      5//16
...
//频率计模式
#define FC_F				100000000  //菜单响应用这个 实际时间：1E8*8nS=0.8S
...
#define MSG_WRITE_IIC			0x12
#define MSG_READ_IIC			0x13	
...
#define MSG_SET_FC			0x4f

#define MSG_READ_FPGA_VERSION		0x4E
#define MSG_READ_PCB_VERSION		0xAA4
...
#define DDS_MSG_FOAC				0x63
#define DDS_MSG_AMFM				0x64
#define MSG_SET_ADCCHMOD_GAIN	0x60
#define MSG_SET_AMP_CALI		0x61//下载波形
#define MSG_SET_CHLEVEL_DIRECT	0x62
//

#define MSG_C_SET_BAUDRATE		0x70
#define MSG_C_SET_CANTRIGGER	0x71
#define MSG_C_SET_CANID			0x72
#define MSG_C_SET_CANDATA		0x73
#define MSG_C_SET_CANIDLE		0x74
#define MSG_C_SET_UART			0x75
#define MSG_C_SET_SPI			0x76
#define MSG_C_SET_IIC			0x77
